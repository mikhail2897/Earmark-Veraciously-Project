...
credentials = json.load(open('C:/Users/trish/Desktop/syracuse/Sem 1/IST.659.M001.FALL21.Data Admin Concepts and Db Mgmt 17224.1221/credentials.json'))
...
#receipt_url = r'C:\Users\trish\Desktop\syracuse\Sem 1\IST.659.M001.FALL21.Data Admin Concepts and Db Mgmt 17224.1221\destiny_popcorn.jpeg'
#receipt_url = r'C:\Users\trish\Desktop\syracuse\Sem 1\IST.659.M001.FALL21.Data Admin Concepts and Db Mgmt 17224.1221\destiny_popcorn.jpeg'

#poller = form_recognizer_client.begin_recognize_receipts_from_url(receipt_url)
#poller = form_recognizer_client.begin_recognize_receipts(receipt_url,FormContentType='IMAGE_JPEG')

with open(r"C:\Users\trish\Desktop\syracuse\Sem 1\IST.659.M001.FALL21.Data Admin Concepts and Db Mgmt 17224.1221\wegmans_bill.jpeg", "rb") as f:
...
if poller.status() == 'succeeded' or 'InProgress':
    ...
    for receipt in result:
        ...
        for name, field in receipt.fields.items():
            if name == 'Items':
                print('Purchase Item')
                with open('JSONlog.txt', 'w') as out_f:
        ...
        if None not in (merchant_address, merchant_name, merchant_number, tax,
            ...
            #row = cursor.fetchone()
                    ...
                    # cursor.execute("INSERT INTO expenses \
                        ...
                        #                   exp_description)\
                        #             VALUES (%s, %s, %s, %s, %s, %s)",\
                        #                 (exp_user_id, item_name, item.value
                        #                    ,exp_description))
